  ...
  TronHeistContract.roundInfo(latestRoundID).call().then(function (results) {
    ...
    TronHeistContract.dailyInfo().call().then(function (results) {
      ...
      TronHeistContract.instantWinJackpot().call().then(function (results) {
        ...
        updateInnerHTML('megaJackpotTotal2', window.tronWeb.fromSun(currentRound.instantWinJackpot.toString()).substring(0, 8) + " TRX"); //console.log("GameRound:", results);
        //console.log("latestRoundID", latestRoundID);
...
function getInvestorInfo(_callback) {
  if (!window.tronWeb.isAddress(userWalletAddress)) return; //console.log("userWalletAddress", window.tronWeb.address.fromHex(userWalletAddress));
  //console.log("latestRoundID", latestRoundID);
...
async function updatePrizes() {
  ...
  await TronHeistWinners.getPrizes().call().then(function (result) {
    ...
    updateInnerHTML('roundAirdropTotal2', tronWeb.fromSun(currentAirdropPrize.toNumber()).substring(0, 8) + " TRX"); //console.log("prizes:", tronWeb.fromSun(currentMegaPrize.toNumber()), tronWeb.fromSun(currentAirdropPrize.toNumber()));
  });
}
...
function displayHighestKeyholders() {
  ...
  try {
    ...
    updateInnerHTML('trxEarn0', window.tronWeb.fromSun(dailyPrize.div(100).times(sorted[0].keys.div(totalKeys).times(100).toString())).substring(0, 8) + " TRX"); // this players share of dailyPrize
  } catch (e) {
    updateInnerHTML('leaders0', 'Available!');
    updateInnerHTML('leadersKeys0', '1');
    updateInnerHTML('trxInvested0', "-");
  ...
  try {
    ...
    updateInnerHTML('trxEarn1', window.tronWeb.fromSun(dailyPrize.div(100).times(sorted[1].keys.div(totalKeys).times(100).toString())).substring(0, 8) + " TRX"); // this players share of dailyPrize
  } catch (e) {
    updateInnerHTML('leaders1', 'Available!');
    updateInnerHTML('leadersKeys1', '1');
    updateInnerHTML('trxInvested1', "-");
  ...
  try {
    ...
    updateInnerHTML('trxEarn2', window.tronWeb.fromSun(dailyPrize.div(100).times(sorted[2].keys.div(totalKeys).times(100).toString())).substring(0, 8) + " TRX"); // this players share of dailyPrize
  } catch (e) {
    updateInnerHTML('leaders2', 'Available!');
    updateInnerHTML('leadersKeys2', '1');
    updateInnerHTML('trxInvested2', "-");
  ...
  try {
    ...
    updateInnerHTML('trxEarn3', window.tronWeb.fromSun(dailyPrize.div(100).times(sorted[3].keys.div(totalKeys).times(100).toString())).substring(0, 8) + " TRX"); // this players share of dailyPrize
  } catch (e) {
    updateInnerHTML('leaders3', 'Available!');
    updateInnerHTML('leadersKeys3', '1');
    updateInnerHTML('trxInvested3', "-");
...
function updateClocks() {
  ...
  if (currentRound.isDark) triggerUpdateRate = 2;
  eventUpdates++;
  ...
  if (currentRound.isDark) {
    ...
    if (currentRound.softDeadline.toNumber() > 0) {
      var dateNow = new Date().getTime();
      var difference = currentRound.softDeadline.toNumber() * 1000 - dateNow; //console.log(difference);
      ...
      if (difference < 1) {
        ...
        if (parseInt(minutesDifference) < 7 && parseInt(hoursDifference) == 0 && triggerUpdate) {
          ...
          getGameRound(getInvestorInfo); //updatePrizes();
        }
  ...
  updateInnerHTML('dailyClock', _diffStr2); //console.log("DAILY DIFF:", _diff);
        ...
        TronHeistContract.reinvestReturns(window.tronWeb.toSun(investmentAmountTRX), _ref, instantWinCode, safetyDepositCode).send({// shouldPollResponse: true
          ...
          if (!_hasErr) {
            ...
            */
            ...
            _msg += '<p style="font-size: 10pt;"><b>The more players we have - the more profits you share!</b></p>';
            showComplete(_msg, "Purchase Complete");
            getGameRound(getInvestorInfo); //updateEvents();
          }
        });
      }
    }
