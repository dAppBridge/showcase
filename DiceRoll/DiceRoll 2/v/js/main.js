      ...
      {from: account,
        ...
        .then(function(receipt){
          try{
            ...
            retMsg += 'Etherscan link: <br/><span class="small"><a href="https://ropsten.etherscan.io/tx/' + receipt.transactionHash + '" target="_new">'; 
...
function showBet(betID){
  ...
  fromBlock:0, toBlock: 'latest'}, function(err, results){
    ...
    if(results.length > 1){
      ...
      _msg += '<tr><td>TX</td><td class="small"><a href="https://ropsten.etherscan.io/tx/' + tx_hash + '" target="_new">' + tx_hash + '</td></tr>';
