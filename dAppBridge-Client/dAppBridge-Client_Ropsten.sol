...
contract clientOfdAppBridge {
    ...
    address internal _dAppBridgeLocator_Ropsten_addr = 0xF96772C64965C3a2185DC9DC84F24134740Ff715;
    ...
    function initBridge() internal {
        ...
        if(address(dAppBridgeLocator) != _dAppBridgeLocator_Ropsten_addr){ 
            dAppBridgeLocator = DappBridgeLocator_I(_dAppBridgeLocator_Ropsten_addr);
        }
